...
public class Pi 
{
    ...
    {
	long total=0;
	int nbWorker = 12; // Oui c'est ça qu'il faut changer 1,2,3,...12
	int ntot = 1200000000;  // ça aussi ancienne valeur : 100000
...
// Ajout
		try (FileWriter writer = new FileWriter("data/Pi_scal_forte_G21_12c.csv", true)) {
			boolean isFileEmpty = new java.io.File("data/Pi_scal_forte_G21_12c.csv").length() == 0;
			if (isFileEmpty) {
